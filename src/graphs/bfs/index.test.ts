import { BFSGraphNode, getPathBFS, isTreeBFS, topologySortBFS } from "."

const getDestinationGraphNodes = (destinationExists: boolean) => {
  const node32 = new BFSGraphNode("Piotr", [], destinationExists)
  const node31 = new BFSGraphNode("Patrycja", [])
  const node3 = new BFSGraphNode("Alicja", [node31, node32])
  const node21 = new BFSGraphNode("Tamara", [])
  const node22 = new BFSGraphNode("Jarek", [])
  const node2 = new BFSGraphNode("Cecylia", [node21, node22])
  const node11 = new BFSGraphNode("Janusz", [])
  const node1 = new BFSGraphNode("Bartek", [node11, node31])
  const startingPoint = new BFSGraphNode("Me", [node1, node2, node3])
...
describe("Infinite Loop", ()=>{
  it("Infinite loop doesn't happen", () => {
    const node1 = new BFSGraphNode("Node1", [])
    const node21 = new BFSGraphNode("Node21", [])
    const node22 = new BFSGraphNode("Node22", [])
    const node2 = new BFSGraphNode("Node2", [node21, node22])
...
describe("Topology Sort", () => {
  ...
  it("Throws an error when graph has cycles in the middle", () => {
    const node21 = new BFSGraphNode("Node21", [])
    const node22 = new BFSGraphNode("Node22", [node21])
    node21.linkedWith.push(node22)
    const node2 = new BFSGraphNode("Node2", [node21, node22])
    const node1 = new BFSGraphNode("Node1", [node2])

    expect(() => topologySortBFS(node1)).toThrowError("Graph has cycles")
  })

  it("Throws on complex graph with cycles", ()=>{
    const node41 = new BFSGraphNode("Node41", [])
    const node31 = new BFSGraphNode("Node31", [node41])
    const node32 = new BFSGraphNode("Node32", [])
    const node21 = new BFSGraphNode("Node21", [node31])
    const node22 = new BFSGraphNode("Node22", [node32])
    const node1 = new BFSGraphNode("Node1", [node21, node22])
  ...
  it("Sorts complex graph 2", ()=>{
    const node42 = new BFSGraphNode("Node42", [])
    const node41 = new BFSGraphNode("Node41", [])
    const node31 = new BFSGraphNode("Node31", [node41])
    const node32 = new BFSGraphNode("Node32", [])
    const node21 = new BFSGraphNode("Node21", [node31])
  ...
  it("Sorts graph correctly revisiting node 3 times", ()=>{
    const node51 = new BFSGraphNode("Node51", [])
    const node41 = new BFSGraphNode("Node41", [node51])
    const node34 = new BFSGraphNode("Node34", [node41])
    const node33 = new BFSGraphNode("Node33", [])
    const node32 = new BFSGraphNode("Node32", [])
    const node31 = new BFSGraphNode("Node31", [])
    const node23 = new BFSGraphNode("Node23", [node34])
    const node22 = new BFSGraphNode("Node22", [node33])
    const node21 = new BFSGraphNode("Node21", [node31, node32])
    const node1 = new BFSGraphNode("Node1", [node21, node22, node23])
  ...
  it("Sorts very complex graph", () => {
    const node44 = new BFSGraphNode("Node44", [])
    const node43 = new BFSGraphNode("Node43", [node44])
    const node42 = new BFSGraphNode("Node42", [])
    const node41 = new BFSGraphNode("Node41", [])
    const node33 = new BFSGraphNode("Node33", [node44])
    const node32 = new BFSGraphNode("Node32", [node43, node33])
    const node31 = new BFSGraphNode("Node31", [node41, node42])
    const node23 = new BFSGraphNode("Node23", [node32, node33])
    const node22 = new BFSGraphNode("Node22", [node31, node32])
    const node21 = new BFSGraphNode("Node21", [node31])
    const node1 = new BFSGraphNode("Node1", [node21, node22, node23])
  ...
  it("Sorts simple graph correctly", ()=>{
    const node4 = new BFSGraphNode("Node4", [])
    const node2 = new BFSGraphNode("Node2", [])
    const node3 = new BFSGraphNode("Node3", [node4])
    const node1 = new BFSGraphNode("Node1", [node2, node3])
  ...
  it("Sorts graph correctly", ()=>{
    ...
    const node2 = new BFSGraphNode("Node2", [node21, node22])
    const node31 = new BFSGraphNode("Node31", [])
    const node3 = new BFSGraphNode("Node3", [node31])
    const node4 = new BFSGraphNode("Node4", [])
    const node1 = new BFSGraphNode("Node1", [node2, node3, node4])
  ...
  it("Sorts graph with multiple parents of the element in the middle correctly", ()=>{
    ...
    const node311 = new BFSGraphNode("Node311")
    const node312 = new BFSGraphNode("Node312")
...
describe("Trees", () => { 
  it("Detects a tree correctly - 1", ()=>{
    const node34 = new BFSGraphNode("Node34")
    const node33 = new BFSGraphNode("Node33")
    const node32 = new BFSGraphNode("Node32")
    const node31 = new BFSGraphNode("Node31")
    const node22 = new BFSGraphNode("Node22", [node33, node34])
    const node21 = new BFSGraphNode("Node21", [node31, node32])
    const node1 = new BFSGraphNode("Node1", [node21, node22])
